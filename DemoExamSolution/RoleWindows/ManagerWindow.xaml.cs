            ...
            try
            {
                ...
                var products = _context.Products
                    ...
                    .Select(p => new ProductViewModel
                    {
                        Id = p.Id,
                        Articul = p.Articul,
                        ProductName = p.IdProductTypeNavigation.Type.Trim(),
                        CategoryName = p.IdCategoryNavigation.CategoryName.Trim(),
                        Description = p.Description.Trim(),
                        Manufacturer = p.IdManufacturerNavigation.ManufacturerName.Trim(),
                        Supplier = p.IdSupplierNavigation.SupplierName.Trim(),
                        Price = p.Price,
